  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        display: ['var(--font-poppins)', 'Poppins', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'sans-serif'],
      },
      fontSize: {
      ...
      backgroundImage: {
        ...
        'mesh-gradient': 'linear-gradient(135deg, #6C5CE7 0%, #A29BFE 25%, #00CED1 50%, #4ECDC4 75%, #FFD700 100%)',
      },
    },
  },
  plugins: [
